<template>
    <u-page page-title="Users Management" page-description="You can invite or remove workspace user">
        <template #header-action>
            <u-button size="lg" icon="i-heroicons-user-plus">Invite new users</u-button>
        </template>
        <div class="grid grid-cols-12 gap-4 h-fit">
            <div
                class="col-span-12 md:col-span-10 lg:col-span-8 row-span-1 grid grid-cols-12 gap-4">
