<template>
    <u-page page-title="Users Management" page-description="A list of all users in your account including their name, title, email and role">
        ...
        <div class="grid grid-cols-12 gap-4 h-fit">
            <div class="col-span-12 md:col-span-12 lg:col-span-10 row-span-1 grid grid-cols-12 gap-4">
                <div class="col-span-6 sm:col-span-6 lg:col-span-3 row-span-1">
                    <users-management-summary-card v-bind="summaryData.totalUsers"></users-management-summary-card>
                </div>
                <div class="col-span-6 sm:col-span-6 lg:col-span-3 row-span-1">
                    <users-management-summary-card v-bind="summaryData.activeUsers"></users-management-summary-card>
                </div>
                <div class="col-span-6 sm:col-span-6 lg:col-span-3 row-span-1">
                    <users-management-summary-card v-bind="summaryData.newUsers"></users-management-summary-card>
                </div>
                <div class="col-span-6 sm:col-span-6 lg:col-span-3 row-span-1">
                    <users-management-summary-card v-bind="summaryData.totalMember"></users-management-summary-card>
                </div>
            </div>
        ...
        <template #modal>
            <users-management-invite-user-form v-if="modalKey === MODAL_KEY.INVITE_USER"></users-management-invite-user-form>
        </template>
    </u-page>
</template>
