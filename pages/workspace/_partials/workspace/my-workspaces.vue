        ...
        <u-list :items="items">
            <template #item="{ item }">
                <u-list-item v-bind="item" hover-class="hover:bg-gray-100 hover:text-gray-900" class="whitespace-nowrap">
                    <template #icon="{ icon }">
                        <u-avatar v-if="item.admin" chip-color="primary" chip-text="A" chip-position="bottom-right"
                            size="sm" :icon="icon" class="ring-4 ring-gray-50">
                        </u-avatar>
                        <u-avatar v-else size="sm" :icon="icon" class="ring-4 ring-gray-50">
                        </u-avatar>
                    </template>
                    <template #action>
                        <u-button variant="soft" size="xs" icon="i-heroicons-arrow-right"></u-button>
                    </template>
                </u-list-item>
            </template>
        </u-list>
...
const items = ref([{
    ...
    title: 'Workspace Incheuo',
    description: 'Create by MiguelBui',
    icon: 'i-heroicons-briefcase',
    value: 'WORKSPACE_01'
}, {
    title: 'Workspace Samisuxe',
    description: 'Create by MiguelBui',
    icon: 'i-heroicons-briefcase',
    value: 'WORKSPACE_01',
    admin: true
