  ...
  <div class="flex flex-col justify-center items-stretch gap-16 w-full h-fit">
    <div class="flex flex-col justify-center items-stretch text-center gap-2">
      <h6 class="text-3xl font-semibold">
        {{ $t(`onboarding.invite.Invite Users`) }}
      </h6>
      <p class="text-sm opacity-60">
        {{
          $t(`onboarding.invite.The information we collect about your business`)
        }}
      </p>
    </div>
    <u-card class="flex-grow" :ui="uiCard">
      <div class="flex flex-col justify-start items-stretch gap-4">
        <u-table
          ...
          :rows="inviteEmails"
          :ui="{
            wrapper: 'ring-1 ring-gray-200 dark:ring-gray-800 rounded-md',
            td: { base: 'max-w-[0] truncate', padding: 'px-3 py-2' },
          }"
        >
        ...
        >
          <u-form ref="form" :state="state" :schema="schema">
            <div
              class="flex flex-col justify-start items-stretch md:items-start md:flex-row gap-2"
            >
              <u-form-group
                required
                name="email"
      ...
      <template #footer>
        <div class="flex flex-row justify-end items-center gap-x-1">
          <u-button size="md" variant="soft" color="gray" class="px-6">{{
          ...
          <u-button
            ...
            >{{ $t(`general.button.Send Invite`) }}</u-button
          >
        </div>
      </template>
    </u-card>
