        ...
        <div class="flex flex-col justify-between items-stretch h-full w-full">
          <u-card :ui="cardUI">
            <template #header>
              <div class="flex flex-row justify-between items-center">
                <the-logo></the-logo>
                <u-button color="gray" variant="ghost" icon="i-heroicons-x-mark-20-solid"
                  @click="toggleSidebar"></u-button>
              </div>
            </template>
            <the-menu></the-menu>
          </u-card>
          <u-card :ui="cardUI">
            <div class="flex flex-col justify-start items-stretch gap-y-4">
              <u-list-item title="Setting" icon="i-heroicons-cog-8-tooth" @click="onGoToSettingPage"></u-list-item>
              <div class="p-2">
                <u-card :ui="{...cardUI, background: 'bg-gray-50'}">
                  <the-support-card :minimum="false"></the-support-card>
                </u-card>
              </div>
            </div>
          </u-card>
