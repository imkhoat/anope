<template>
    <div class="grid grid-cols-12 h-full" :class="pageClass">
        ...
        <div class="p-4 col-span-12" :class="pageBodyClass">
            <div class="u-page__body bg-white rounded-2xl w-full h-full flex flex-col justify-start items-stretch gap-y-12"
                        ...
                        <slot name="header-title">
                            <div class="flex flex-row justify-start items-center gap-x-3">
                                <u-waves-avatar :icon="pageIcon">
                                    <u-icon v-if="pageIcon" :name="pageIcon" class="w-5 h-5 bg-gray-500"></u-icon>
                                </u-waves-avatar>
