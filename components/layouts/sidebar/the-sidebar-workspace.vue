<template>
  <div class="the-default-sidebar border-r border-gray-200">
    ...
    <div class="flex lg:hidden">
      <u-slideover :model-value="collapse && !isDesktop" :side="'left'">
        <u-card :ui="cardUI">
          ...
          <the-menu-workspace class="flex-grow" :collapse="false" />
          <template #footer>
    ...
    >
      ...
      <the-menu-workspace :collapse="collapse" class="flex-grow" />
...
import TheMenuWorkspace from '@/components/layouts/sidebar/menu/the-menu-workspace.vue'
